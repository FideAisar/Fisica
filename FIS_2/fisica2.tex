...
Una corrente è detta stazionara se è nulla la divergenza di flusso di corrente, ovvero se "entra tanta corrente quanta ne esce" da una superficie chiusa interna al conduttore.
\begin{equation}
	\vec{\nabla} \cdot \vec{j} = 0
\end{equation}
}

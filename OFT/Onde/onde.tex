...
\subsection{Onde in una sbarra solida}
	...
	\begin{center}
		\fboxsep6pt
		\colorbox{myred}{\begin{minipage}{2in}
		\vspace{-0.3cm}
		\begin{equation}
		\frac{\partial^2\xi}{\partial x^2} = \frac{\rho}{E} \frac{\partial^2 \xi}{\partial t^2} \qquad \qquad v = \sqrt{\frac{E}{\rho}}
		\end{equation}
		\end{minipage}}
	\end{center}
	...
	\begin{center}
		\fboxsep6pt
		\colorbox{myred}{\begin{minipage}{2.2in}
				\vspace{-0.3cm}
				\begin{equation}
					\frac{\partial^2F}{\partial x^2} = \frac{1}{v^2} \frac{\partial^2 F}{\partial t^2} \qquad \qquad v = \sqrt{\frac{E}{\rho}}
				\end{equation}
		\end{minipage}}
	\end{center}
...
\subsection{Onde in una corda tesa}
	...
	\begin{center}
		...
		\colorbox{myred}{\begin{minipage}{2in}
				\vspace{-0.3cm}
				\begin{equation}
					\frac{\partial^2\xi}{\partial x^2} = \frac{\mu}{T} \frac{\partial^2 \xi}{\partial t^2} \qquad \qquad v = \sqrt{\frac{T}{\mu}}
				\end{equation}
		\end{minipage}}
	\end{center}
...
\subsection{Onde nei gas}
	Riprendiamo la definizione di \textbf{modulo di compressibilità} \(\beta = -V\frac{dp}{dV}\). Il valore di \(\beta\) dipende da come la pressione varia con la densità
	\\
	\noindent
...
\]
	...
	\newpage
	\subsection{Propagazione dell'energia}
	La propagazione di un campo che descrive in'onda è sempre accompagnato da una propagazione di energia. Per ottenere un'espressione del flusso di energia legato alla propagazione di un'onda piana armonica consideriamo un'onda in una barra solida e calcolo la potenzia media e l'energia per untià di volume ad essa associata.\\
	...
	\end{align*}
	La potenza quindi è una cosinusoide traslata in alto di una sua ampiezza (con avvallamenti tangenti all'asse orizzontale). la potenza media è espirmibile come la retta che interseca la cosinusoide alla quota pari a metà la sua ampiezza; poi ricordandoci che l'espressione della velocità \(v = \sqrt{E/\rho}\) esprimo \(E = v^2 \rho\):
	...
	\begin{align*}
		\bar{\mathcal{P}} =& \frac{1}{2} ESk\omega \xi_0^2  \\
			=& \frac{1}{2} (v^2 \rho)S\left(\frac{\omega}{v}\right) \omega\xi_0^2 
	\end{align*}
	\begin{center}
		\fboxsep6pt
		\colorbox{myred}{\begin{minipage}{1.5in}
				%\vspace{-0.3cm}
				\begin{equation}
					\bar{\mathcal{P}} = \frac{1}{2}\rho \omega^2 \xi^2 S v
				\end{equation}
		\end{minipage}}
	\end{center}
	...
	\[ 
	dU = \frac{1}{2}(dm)v_{\text{max}}^2 = \frac{1}{2}\rho S (dx)\omega^2 \xi_0^2 = \frac{1}{2}\rho V\omega^2 \xi_0^2
	\]
	...
	\begin{center}
		\fboxsep6pt
		\colorbox{myred}{\begin{minipage}{4in}
				\vspace{0.1cm}
				\begin{equation}
					\frac{\partial^2\xi(x,y,t)}{\partial y^2} + \frac{\partial^2\xi(x,y,t)}{\partial x^2} = \frac{\rho_s}{T}\frac{\partial^2\xi(x,y,t)}{\partial t^2} \qquad v = \sqrt{\frac{T}{\rho_s}}
				\end{equation}
		\end{minipage}}
	\end{center}
	...
	\noindent
	Diciamo che la nostra sorgente emetta un'onda di intensità \(I(r) = CA^2(r)\) dove \(C\) è una costante dipendente dal mezzo. Il punto fondamentale nella comprensione delle onde sferiche sta nel fatto che la potenza media trasmessa attraverso la superficie sferica \(S = 4\pi r^2\) deve risultare costante ad ogni valore di \(r\):
	...
	\noindent
	Risulta quindi che l'ampiezza è inversamente proporzionale alla distanza \(r\) e quindi può essere scritta come \(A = \xi_0 /r\).
	...
	\begin{center}
		...
		\colorbox{myred}{\begin{minipage}{2in}
				%\vspace{-0.3cm}
				\begin{equation}
					\xi(r,t) = \frac{\xi_0}{r}\sin\left(kr -\omega t\right)
				\end{equation}
		\end{minipage}}
	\end{center}

\newpage
\subsection{Intensità delle onde sonore}

...
\subsection{Onde nei gas}
	...
	\begin{center}
		\fboxsep6pt
		\colorbox{myred}{\begin{minipage}{3in}
				%\vspace{-0.3cm}
				\begin{equation}
					\frac{\partial^2\xi}{\partial x^2} = \frac{\rho_0}{\beta} \frac{\partial^2 \xi}{\partial t^2} \qquad \qquad v = \sqrt{\frac{\beta}{\rho_0}}
				\end{equation}
		\end{minipage}}
	\end{center}
\newpage
...
\]
	...
	\begin{center}
		\fboxsep6pt
		\colorbox{myred}{\begin{minipage}{1.2in}
				%\vspace{-0.3cm}
				\begin{equation}
	...
	Definiamo l'intensità di un'onda com e\textbf{potenza media per unità di superficie}, quindi
	...
	\begin{center}
		...
		\colorbox{myred}{\begin{minipage}{1.2in}
				\vspace{-0.3cm}
				\begin{equation}
					\bar{\mathcal{P}} = \frac{1}{2}\mu\omega^2\xi^2v
				\end{equation}
		\end{minipage}}
	\end{center}

...
\begin{document}
	...
	\paragraph{Ipotesi del test (H$_{0}$)} La distribuzione teorica di Gauss si adatta alla distribuzione delle mie misure. 
	...
	\[
	z = \frac{x-\mu}{\sigma} \qquad \to \qquad \frac{1}{\sqrt{2\pi}\sigma} \int_{-t}^{t}e^{-\frac{-z^2}{2}} \,dz
	\]

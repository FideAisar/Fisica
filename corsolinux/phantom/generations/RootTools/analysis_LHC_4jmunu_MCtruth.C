/*
 *analysis_LHC_4jmunu_MCtruth.C
 *
 *Last update: April 12, 2008
 *
 * The neutrino information is taken from the event file without reconstruction
...
void analysis_LHC_4jmunu_MCtruth(void);
double integro(TH1D*);
double integro(TH1D*,double,double);


void analysis_LHC_4jmunu_MCtruth() {
 ...
 ******************************************************************************/
  ...
  cout<<endl;
  cout<<"**************************************************************"<<endl;
  cout<<"               -- analysis_LHC_4jmunu_reco --                 "<<endl;
...
// The neutrino is NOT reconstructed but simply read from the file

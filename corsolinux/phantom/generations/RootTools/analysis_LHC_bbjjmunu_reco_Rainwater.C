/*
 *analysis_LHC_bbjjmunu_reco.C
 *
 *Last update: April 12, 2008
 *
 * The two central jets are required to be b-tagged.
 * Using Rainwater-like b tagging Abs(Eta_b)<2.5 Btagging_efficiency=1
 *
 ******************************************************************************/
...
void analysis_LHC_bbjjmunu_reco(void);
double integro(TH1D*);
double integro(TH1D*,double,double);


void analysis_LHC_bbjjmunu_reco() {
  ...
  TLorentzVector jf, jb, jc[2], jj, jjj, tot_vis, jlv, jfjb, V[2], 
    ...
    v_dummy;
  Int_t n_j, n_clep, n_nu, index_jet[8],index_jc[2];
...
*/
  Btagging_region = 2.5;  // B-tagging active on |eta| < Btagging_region
  Btagging_efficiency=1.0;
 ...
 ******************************************************************************/
  ...
  cout<<endl;
  cout<<"**************************************************************"<<endl;
  cout<<"               -- analysis_LHC_bbjjmunu_reco --                 "<<endl;

...
void analysis_LHC_4jmunu(TString opt, Double_t rmh) {
  ...
  TString setcuts_E_min_j, setcuts_E_min_clep, setcuts_pT_min_j, 
    ...
    setcuts_DRHj,setcuts_deltaetaVV,setcuts_TotVisM;
  ...
  static Int_t ipasscuts,ipassDR;
 ...
 ******************************************************************************/
  ...
  cin>>setcuts_E_min_j>>dummy;;
//  cout<<"setcuts_E_min_j:"<<setcuts_E_min_j<<endl;
//  setcuts_E_min_j="n";
  if(setcuts_E_min_j=="y"){
    cin>>cut_E_min_j>>dummy;
//  cout<<"cut_E_min_j:"<<cut_E_min_j<<" GeV"<<endl;
//  cout<<"dummy:"<<dummy<<"&&&"<<endl;
//  cut_E_min_j = 20.0;
  }
  //Minimum energy for charged leptons
  cin>>setcuts_E_min_clep>>dummy;;
//  setcuts_E_min_clep="n";
//  cut_E_min_clep = 20.0;
  if(setcuts_E_min_clep=="y"){
    cin>>cut_E_min_clep>>dummy;
  }
  //Minimum pT for jets
//  setcuts_pT_min_j="y";
//  cut_pT_min_j = 30.0;
 ...
 ******************************************************************************/
  ...
  if(setcuts_DRHj=="y"){
    TString s="minimum DeltaR between H system and jet:";
    s+=cut_DRHj;
    text_cuts.AddText(s.Data());
  }
  if(setTopcut_jjj=="y"){
        ...
        if(setcuts_DRHj=="y"){
          ...
          for(Int_t k=0;k<n_j;k++) {
            if(index_jet[k]!= index_jet_bj[index_sort[0]]
                && index_jet[k]!=is_a_b){ 
              auxa=p_bj[index_sort[0]].Eta()-particle[index_jet[k]].Eta();
              auxb=p_bj[index_sort[0]].DeltaPhi(particle[index_jet[k]]);
              auxdelta = TMath::Sqrt(auxa*auxa+auxb*auxb);
              if(auxdelta < DR){
             DR = auxdelta;
              }

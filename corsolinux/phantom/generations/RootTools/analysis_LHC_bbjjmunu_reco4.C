...
void analysis_LHC_bbjjmunu_reco4(void);
double integro(TH1D*);
double integro(TH1D*,double,double);


void analysis_LHC_bbjjmunu_reco4() {
 ...
 ******************************************************************************/
  ...
  //Mimic b-tagging
  Btagging_region = 2.4;  // B-tagging active on |eta| < Btagging_region
 ...
 ******************************************************************************/
  ...
  cout<<endl;
  cout<<"**************************************************************"<<endl;
  cout<<"               -- analysis_LHC_bbjjmunu_reco4 --                 "<<endl;

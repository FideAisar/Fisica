...
void analysis_LHC_bbjjmunu_reco3(void);
double integro(TH1D*);
double integro(TH1D*,double,double);


void analysis_LHC_bbjjmunu_reco3() {
 ...
 ******************************************************************************/
  ...
  cout<<endl;
  cout<<"**************************************************************"<<endl;
  cout<<"               -- analysis_LHC_bbjjmunu_reco3 --                 "<<endl;

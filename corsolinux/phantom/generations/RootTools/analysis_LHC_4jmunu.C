...
void analysis_LHC_4jmunu(TString opt) {
  ...
  TString setcuts_E_min_j, setcuts_E_min_clep, setcuts_pT_min_j, 
    ...
    setBveto, setBsingletag, setTopcut_jjj, setTopcut_jlv_rec;
 ...
 ******************************************************************************/
  ...
  setBveto="y";           // rejects b-tagged events
  setBsingletag="n";      // accepts b-tagged events only
 ...
 ******************************************************************************/
  ...
  hew_Mlv_cuts.SetTitle("Invariant mass of l#nu system with no selection cut");

  TH1D hew_Mjj_cuts("hew_Mjj_cuts",";M_{jj} (GeV)",nbins_M,Mjj_low,Mjj_high);
  hew_Mjj_cuts.SetTitle("Invariant mass of j{_c}j{_c} system with no selection cut");

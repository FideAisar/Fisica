 ...
 ******************************************************************************/
  ...
  Btagging_region = 6.5;  // B-tagging active on |eta| < Btagging_region
  Btagging_efficiency=1.0;
  setBveto="n";           // rejects b-tagged events
  setBsingletag="n";      // accepts single b-tagged events only
  setBdoubletag="n";      // accepts double b-tagged events only

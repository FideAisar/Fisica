...
c OSP 1 (giovanni, 23/3/2017)
c      common/countBT/ncountsBT
c OSP 1 end (giovanni, 23/3/2017) 
...
c If some phase space is eliminated two more iteration are forced
        alfamin=1.d-3
*zw
        if (abs(iproc(1)).eq.5.and.abs(iproc(2)).eq.5) alfamin=8.d-2
*zwend
...
c 208  FORMAT(' Sigma = ',d13.7,' +/-',d10.3,' (pb)')
 208  FORMAT(' SIGMA = ',d13.7,' +/-',d10.3,' (pb)')
c OSP 1 giovanni (23/3/2017)  
c      print*,'ncountsBT = ', ncountsBT
c OSP 1 giovanni end (23/3/2017)       
      RETURN
      END

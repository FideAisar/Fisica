...
*                                                                       
      ...
      subroutine twoztwow_massless(p1,p2,p3,p4,p5,p6,p7,p8,
...
*forks (vector)                                                         
      ...
      type(pola) cz12(2),cf12(2),cz34(2),cf34(2),cw56,cw78
* left                                                                  
      type l_line
...
* four2four vector                                                      
      type(pola) cz1234(2,2),cf1234(2,2),cw1256(2),cw1278(2),
     &           cz5678,     cf5678,     cw3478(2),cw3456(2)
      dimension ch1234(2,2)   ! ch5678
  
* triple vertex auxiliary vector                                        
      dimension cwaux(2,0:3),c4aux(2,2),c2aux1(2),c2aux2(2),cvaux(0:3)
  
* four2four                                                             
      dimension c1234(2,2),c1256(2,2),c1278(2,2), cquart(2,2)
      dimension cres(2,2),cunit(2,2)
...
* pol z transverse                                                      
        ...
        if (iceps1.eq.1) then
          do i=1,2
* p.q -- p.q=cscalz(i),p=ceps1,q=cz12(i)%e,bef=,aft=
      cscalz(i)=(ceps1(0)*cz12(i)%e(0)-ceps1(1)*cz12(i)%e(1)-cep
     & s1(2)*cz12(i)%e(2)-ceps1(3)*cz12(i)%e(3))
  
            do mu=0,3
              cz12(i)%e(mu)=cscalz(i)*conjg(ceps1(mu))
            enddo
          enddo
        endif
        ...
        if (iceps2.eq.1) then
          do i=1,2
* p.q -- p.q=cscal1z(i),p=ceps1,q=cz12(i)%e,bef=,aft=
      cscal1z(i)=(ceps1(0)*cz12(i)%e(0)-ceps1(1)*cz12(i)%e(1)-ce
     & ps1(2)*cz12(i)%e(2)-ceps1(3)*cz12(i)%e(3))
  
* p.q -- p.q=cscal2z(i),p=ceps2,q=cz12(i)%e,bef=,aft=
      cscal2z(i)=(ceps2(0)*cz12(i)%e(0)-ceps2(1)*cz12(i)%e(1)-ce
     & ps2(2)*cz12(i)%e(2)-ceps2(3)*cz12(i)%e(3))
  
            do mu=0,3
              cz12(i)%e(mu)=cscal1z(i)*conjg(ceps1(mu))
...
* pol z transverse                                                      
        ...
        if (iceps1.eq.1) then
          do i=1,2
* p.q -- p.q=cscalz(i),p=ceps1,q=cz34(i)%e,bef=,aft=
      cscalz(i)=(ceps1(0)*cz34(i)%e(0)-ceps1(1)*cz34(i)%e(1)-cep
     & s1(2)*cz34(i)%e(2)-ceps1(3)*cz34(i)%e(3))
  
            do mu=0,3
              cz34(i)%e(mu)=cscalz(i)*conjg(ceps1(mu))
            enddo
          enddo
        endif
        ...
        if (iceps2.eq.1) then
          do i=1,2
* p.q -- p.q=cscal1z(i),p=ceps1,q=cz34(i)%e,bef=,aft=
      cscal1z(i)=(ceps1(0)*cz34(i)%e(0)-ceps1(1)*cz34(i)%e(1)-ce
     & ps1(2)*cz34(i)%e(2)-ceps1(3)*cz34(i)%e(3))
  
* p.q -- p.q=cscal2z(i),p=ceps2,q=cz34(i)%e,bef=,aft=
      cscal2z(i)=(ceps2(0)*cz34(i)%e(0)-ceps2(1)*cz34(i)%e(1)-ce
     & ps2(2)*cz34(i)%e(2)-ceps2(3)*cz34(i)%e(3))
  
            do mu=0,3
              cz34(i)%e(mu)=cscal1z(i)*conjg(ceps1(mu))
     &           +cscal2z(i)*conjg(ceps2(mu))
            enddo
          enddo
        endif
...
*zw                                                                     
      cauxmw2=cmw2
      if ((i_ww.eq.2.or.(i_ww.eq.1.and.i_zz.eq.1)).
     &     and.i_osp.eq.2.and.iresw(5).eq.1) then
...
*zw                                                                     
      cauxmw2=cmw2
      if ((i_ww.eq.2.or.(i_ww.eq.1.and.i_zz.eq.1)).
     &     and.i_osp.eq.2.and.iresw(7).eq.1) then
        cauxmw2=rmw2*cuno-cim*gamw*rmw
      endif
...
* u178_34(i3)%c,d=u178_34(i3)%d,cl=fcl(id1-1),nsum=1
     ...
     & e(2)*p256(2)-cf34(i3)%e(3)*p256(3)
      ...
      u178_34(i3)%a(2)=u178_34(i3)%a(2)+fcl(id1-1)*(cauxa-ceps_0
     & )
      u178_34(i3)%b(1)=u178_34(i3)%b(1)+fcl(id1-1)*(cauxb-ceps_2
     & )
      u178_34(i3)%c(2)=u178_34(i3)%c(2)+fcl(id1-1)*(-cauxc+ceps_
     & 1)
      u178_34(i3)%d(1)=u178_34(i3)%d(1)+fcl(id1-1)*cf34(i3)%ek0
      end do
        endif
      else
* quqd -- p=p156,q=p278
...
* u156_34(i3)%c,d=u156_34(i3)%d,cl=fcl(id1+1),nsum=1
     ...
     & e(2)*p278(2)-cf34(i3)%e(3)*p278(3)
      ...
      u156_34(i3)%a(2)=u156_34(i3)%a(2)+fcl(id1+1)*(cauxa-ceps_0
     & )
      u156_34(i3)%b(1)=u156_34(i3)%b(1)+fcl(id1+1)*(cauxb-ceps_2
     & )
      u156_34(i3)%c(2)=u156_34(i3)%c(2)+fcl(id1+1)*(-cauxc+ceps_
     & 1)
      u156_34(i3)%d(1)=u156_34(i3)%d(1)+fcl(id1+1)*cf34(i3)%ek0
      end do
        endif
      endif
...
* u378_12(i3)%c,d=u378_12(i3)%d,cl=fcl(id3-1),nsum=1
     ...
     & e(2)*p456(2)-cf12(i3)%e(3)*p456(3)
      ...
      u378_12(i3)%a(2)=u378_12(i3)%a(2)+fcl(id3-1)*(cauxa-ceps_0
     & )
      u378_12(i3)%b(1)=u378_12(i3)%b(1)+fcl(id3-1)*(cauxb-ceps_2
     & )
      u378_12(i3)%c(2)=u378_12(i3)%c(2)+fcl(id3-1)*(-cauxc+ceps_
     & 1)
      u378_12(i3)%d(1)=u378_12(i3)%d(1)+fcl(id3-1)*cf12(i3)%ek0
      end do
        endif
      else
* quqd -- p=p356,q=p478
...
* u356_12(i3)%c,d=u356_12(i3)%d,cl=fcl(id3+1),nsum=1
     ...
     & e(2)*p478(2)-cf12(i3)%e(3)*p478(3)
      ...
      u356_12(i3)%a(2)=u356_12(i3)%a(2)+fcl(id3+1)*(cauxa-ceps_0
     & )
      u356_12(i3)%b(1)=u356_12(i3)%b(1)+fcl(id3+1)*(cauxb-ceps_2
     & )
      u356_12(i3)%c(2)=u356_12(i3)%c(2)+fcl(id3+1)*(-cauxc+ceps_
     & 1)
      u356_12(i3)%d(1)=u356_12(i3)%d(1)+fcl(id3+1)*cf12(i3)%ek0
      end do
        endif
      endif
...
* u578_34(i3)%c,d=u578_34(i3)%d,cl=fcl(id6),nsum=1
     ...
     & e(2)*p612(2)-cf34(i3)%e(3)*p612(3)
      ...
      u578_34(i3)%a(2)=u578_34(i3)%a(2)+fcl(id6)*(cauxa-ceps_0)
      u578_34(i3)%b(1)=u578_34(i3)%b(1)+fcl(id6)*(cauxb-ceps_2)
      u578_34(i3)%c(2)=u578_34(i3)%c(2)+fcl(id6)*(-cauxc+ceps_1)
      u578_34(i3)%d(1)=u578_34(i3)%d(1)+fcl(id6)*cf34(i3)%ek0
      end do
      endif
...
* u512_34(i3)%c,d=u512_34(i3)%d,cl=fcl(id5),nsum=1
     ...
     & e(2)*p678(2)-cf34(i3)%e(3)*p678(3)
      ...
      u512_34(i3)%a(2)=u512_34(i3)%a(2)+fcl(id5)*(cauxa-ceps_0)
      u512_34(i3)%b(1)=u512_34(i3)%b(1)+fcl(id5)*(cauxb-ceps_2)
      u512_34(i3)%c(2)=u512_34(i3)%c(2)+fcl(id5)*(-cauxc+ceps_1)
      u512_34(i3)%d(1)=u512_34(i3)%d(1)+fcl(id5)*cf34(i3)%ek0
      end do
      endif
...
* u578_12(i3)%c,d=u578_12(i3)%d,cl=fcl(id6),nsum=1
     ...
     & e(2)*p634(2)-cf12(i3)%e(3)*p634(3)
      ...
      u578_12(i3)%a(2)=u578_12(i3)%a(2)+fcl(id6)*(cauxa-ceps_0)
      u578_12(i3)%b(1)=u578_12(i3)%b(1)+fcl(id6)*(cauxb-ceps_2)
      u578_12(i3)%c(2)=u578_12(i3)%c(2)+fcl(id6)*(-cauxc+ceps_1)
      u578_12(i3)%d(1)=u578_12(i3)%d(1)+fcl(id6)*cf12(i3)%ek0
      end do
      endif
...
* u534_12(i3)%c,d=u534_12(i3)%d,cl=fcl(id5),nsum=1
     ...
     & e(2)*p678(2)-cf12(i3)%e(3)*p678(3)
      ...
      u534_12(i3)%a(2)=u534_12(i3)%a(2)+fcl(id5)*(cauxa-ceps_0)
      u534_12(i3)%b(1)=u534_12(i3)%b(1)+fcl(id5)*(cauxb-ceps_2)
      u534_12(i3)%c(2)=u534_12(i3)%c(2)+fcl(id5)*(-cauxc+ceps_1)
      u534_12(i3)%d(1)=u534_12(i3)%d(1)+fcl(id5)*cf12(i3)%ek0
      end do
      endif
...
* u756_34(i3)%c,d=u756_34(i3)%d,cl=fcl(id8),nsum=1
     ...
     & e(2)*p812(2)-cf34(i3)%e(3)*p812(3)
      ...
      u756_34(i3)%a(2)=u756_34(i3)%a(2)+fcl(id8)*(cauxa-ceps_0)
      u756_34(i3)%b(1)=u756_34(i3)%b(1)+fcl(id8)*(cauxb-ceps_2)
      u756_34(i3)%c(2)=u756_34(i3)%c(2)+fcl(id8)*(-cauxc+ceps_1)
      u756_34(i3)%d(1)=u756_34(i3)%d(1)+fcl(id8)*cf34(i3)%ek0
      end do
      endif
...
* u712_34(i3)%c,d=u712_34(i3)%d,cl=fcl(id7),nsum=1
     ...
     & e(2)*p856(2)-cf34(i3)%e(3)*p856(3)
      ...
      u712_34(i3)%a(2)=u712_34(i3)%a(2)+fcl(id7)*(cauxa-ceps_0)
      u712_34(i3)%b(1)=u712_34(i3)%b(1)+fcl(id7)*(cauxb-ceps_2)
      u712_34(i3)%c(2)=u712_34(i3)%c(2)+fcl(id7)*(-cauxc+ceps_1)
      u712_34(i3)%d(1)=u712_34(i3)%d(1)+fcl(id7)*cf34(i3)%ek0
      end do
      endif
...
* u756_12(i3)%c,d=u756_12(i3)%d,cl=fcl(id8),nsum=1
     ...
     & e(2)*p834(2)-cf12(i3)%e(3)*p834(3)
      ...
      u756_12(i3)%a(2)=u756_12(i3)%a(2)+fcl(id8)*(cauxa-ceps_0)
      u756_12(i3)%b(1)=u756_12(i3)%b(1)+fcl(id8)*(cauxb-ceps_2)
      u756_12(i3)%c(2)=u756_12(i3)%c(2)+fcl(id8)*(-cauxc+ceps_1)
      u756_12(i3)%d(1)=u756_12(i3)%d(1)+fcl(id8)*cf12(i3)%ek0
      end do
      endif
...
* u734_12(i3)%c,d=u734_12(i3)%d,cl=fcl(id7),nsum=1
     ...
     & e(2)*p856(2)-cf12(i3)%e(3)*p856(3)
      ...
      u734_12(i3)%a(2)=u734_12(i3)%a(2)+fcl(id7)*(cauxa-ceps_0)
      u734_12(i3)%b(1)=u734_12(i3)%b(1)+fcl(id7)*(cauxb-ceps_2)
      u734_12(i3)%c(2)=u734_12(i3)%c(2)+fcl(id7)*(-cauxc+ceps_1)
      u734_12(i3)%d(1)=u734_12(i3)%d(1)+fcl(id7)*cf12(i3)%ek0
      end do
      endif
...
* ,b2=u178_56%b,c2=u178_56%c,d2=u178_56%d,prq=p178q,nsum=0
     ...
     & _56%a(2)
      ...
      do i3=1,2
* TLT0_W -- aa=l1_7834(i3)%a,cc=l1_7834(i3)%c,a1=l1_78%a,c1=l1_78%c,a2=u
* 178_34(i3)%a,b2=u178_34(i3)%b,c2=u178_34(i3)%c,d2=u178_34(i3)%d,prq=p1
* 78q,nsum=0
      l1_7834(i3)%c(2)=l1_78%c(2)*p178q*u178_34(i3)%d(1)+l1_78%a
     & (2)*u178_34(i3)%c(2)
      l1_7834(i3)%a(2)=l1_78%c(2)*p178q*u178_34(i3)%b(1)+l1_78%a
     & (2)*u178_34(i3)%a(2)
      end do
...
* =0
      l1_3478(i3)%c(2)=l1_34(i3)%c(2)*p134q*u134_78%d(1)+l1_34(i
     & 3)%a(2)*u134_78%c(2)
      l1_3478(i3)%a(2)=l1_34(i3)%c(2)*p134q*u134_78%b(1)+l1_34(i
     & 3)%a(2)*u134_78%a(2)
      end do
      else
...
* ,b2=u156_78%b,c2=u156_78%c,d2=u156_78%d,prq=p156q,nsum=0
     ...
     & _78%a(2)
      ...
      do i3=1,2
* TLT0_W -- aa=l1_5634(i3)%a,cc=l1_5634(i3)%c,a1=l1_56%a,c1=l1_56%c,a2=u
* 156_34(i3)%a,b2=u156_34(i3)%b,c2=u156_34(i3)%c,d2=u156_34(i3)%d,prq=p1
* 56q,nsum=0
      l1_5634(i3)%c(2)=l1_56%c(2)*p156q*u156_34(i3)%d(1)+l1_56%a
     & (2)*u156_34(i3)%c(2)
      l1_5634(i3)%a(2)=l1_56%c(2)*p156q*u156_34(i3)%b(1)+l1_56%a
     & (2)*u156_34(i3)%a(2)
      end do
...
* =0
      l1_3456(i3)%c(2)=l1_34(i3)%c(2)*p134q*u134_56%d(1)+l1_34(i
     & 3)%a(2)*u134_56%c(2)
      l1_3456(i3)%a(2)=l1_34(i3)%c(2)*p134q*u134_56%b(1)+l1_34(i
     & 3)%a(2)*u134_56%a(2)
      end do
      endif
...
* ,b2=u378_56%b,c2=u378_56%c,d2=u378_56%d,prq=p378q,nsum=0
     ...
     & _56%a(2)
      ...
      do i3=1,2
* TLT0_W -- aa=l3_7812(i3)%a,cc=l3_7812(i3)%c,a1=l3_78%a,c1=l3_78%c,a2=u
* 378_12(i3)%a,b2=u378_12(i3)%b,c2=u378_12(i3)%c,d2=u378_12(i3)%d,prq=p3
* 78q,nsum=0
      l3_7812(i3)%c(2)=l3_78%c(2)*p378q*u378_12(i3)%d(1)+l3_78%a
     & (2)*u378_12(i3)%c(2)
      l3_7812(i3)%a(2)=l3_78%c(2)*p378q*u378_12(i3)%b(1)+l3_78%a
     & (2)*u378_12(i3)%a(2)
      end do
...
* =0
      l3_1278(i3)%c(2)=l3_12(i3)%c(2)*p312q*u312_78%d(1)+l3_12(i
     & 3)%a(2)*u312_78%c(2)
      l3_1278(i3)%a(2)=l3_12(i3)%c(2)*p312q*u312_78%b(1)+l3_12(i
     & 3)%a(2)*u312_78%a(2)
      end do
      else
...
* ,b2=u356_78%b,c2=u356_78%c,d2=u356_78%d,prq=p356q,nsum=0
     ...
     & _78%a(2)
      ...
      do i3=1,2
* TLT0_W -- aa=l3_5612(i3)%a,cc=l3_5612(i3)%c,a1=l3_56%a,c1=l3_56%c,a2=u
* 356_12(i3)%a,b2=u356_12(i3)%b,c2=u356_12(i3)%c,d2=u356_12(i3)%d,prq=p3
* 56q,nsum=0
      l3_5612(i3)%c(2)=l3_56%c(2)*p356q*u356_12(i3)%d(1)+l3_56%a
     & (2)*u356_12(i3)%c(2)
      l3_5612(i3)%a(2)=l3_56%c(2)*p356q*u356_12(i3)%b(1)+l3_56%a
     & (2)*u356_12(i3)%a(2)
      end do
...
* =0
      l3_1256(i3)%c(2)=l3_12(i3)%c(2)*p312q*u312_56%d(1)+l3_12(i
     & 3)%a(2)*u312_56%c(2)
      l3_1256(i3)%a(2)=l3_12(i3)%c(2)*p312q*u312_56%b(1)+l3_12(i
     & 3)%a(2)*u312_56%a(2)
      end do
      endif
...
* main W                                                                
      ...
      do i1=1,2
* TLT0_W -- aa=l5_7812(i1)%a,cc=l5_7812(i1)%c,a1=l5_78%a,c1=l5_78%c,a2=u
* 578_12(i1)%a,b2=u578_12(i1)%b,c2=u578_12(i1)%c,d2=u578_12(i1)%d,prq=p5
* 78q,nsum=0
      l5_7812(i1)%c(2)=l5_78%c(2)*p578q*u578_12(i1)%d(1)+l5_78%a
     & (2)*u578_12(i1)%c(2)
      l5_7812(i1)%a(2)=l5_78%c(2)*p578q*u578_12(i1)%b(1)+l5_78%a
     & (2)*u578_12(i1)%a(2)
      end do
...
* =0
      l5_1278(i1)%c(2)=l5_12(i1)%c(2)*p512q*u512_78%d(1)+l5_12(i
     & 1)%a(2)*u512_78%c(2)
      l5_1278(i1)%a(2)=l5_12(i1)%c(2)*p512q*u512_78%b(1)+l5_12(i
     & 1)%a(2)*u512_78%a(2)
      end do
...
* 4(i3)%d,prq=p512q,nsum=0
     ...
     & l5_12(i1)%a(2)*u512_34(i3)%a(2)
      ...
      do i1=1,2
* TLT0_W -- aa=l5_7834(i1)%a,cc=l5_7834(i1)%c,a1=l5_78%a,c1=l5_78%c,a2=u
* 578_34(i1)%a,b2=u578_34(i1)%b,c2=u578_34(i1)%c,d2=u578_34(i1)%d,prq=p5
* 78q,nsum=0
      l5_7834(i1)%c(2)=l5_78%c(2)*p578q*u578_34(i1)%d(1)+l5_78%a
     & (2)*u578_34(i1)%c(2)
      l5_7834(i1)%a(2)=l5_78%c(2)*p578q*u578_34(i1)%b(1)+l5_78%a
     & (2)*u578_34(i1)%a(2)
      end do
...
* =0
      l5_3478(i1)%c(2)=l5_34(i1)%c(2)*p534q*u534_78%d(1)+l5_34(i
     & 1)%a(2)*u534_78%c(2)
      l5_3478(i1)%a(2)=l5_34(i1)%c(2)*p534q*u534_78%b(1)+l5_34(i
     & 1)%a(2)*u534_78%a(2)
      end do
  
      do i1=1,2
      do i3=1,2
* TLT0_W -- aa=l5_3412(i1,i3)%a,cc=l5_3412(i1,i3)%c,a1=l5_34(i1)%a,c1=l5
* _34(i1)%c,a2=u534_12(i3)%a,b2=u534_12(i3)%b,c2=u534_12(i3)%c,d2=u534_1
* 2(i3)%d,prq=p534q,nsum=0
      l5_3412(i1,i3)%c(2)=l5_34(i1)%c(2)*p534q*u534_12(i3)%d(1)+
     & l5_34(i1)%a(2)*u534_12(i3)%c(2)
      l5_3412(i1,i3)%a(2)=l5_34(i1)%c(2)*p534q*u534_12(i3)%b(1)+
     & l5_34(i1)%a(2)*u534_12(i3)%a(2)
      end do
      end do
  
  
      do i1=1,2
* TLT0_W -- aa=l7_5612(i1)%a,cc=l7_5612(i1)%c,a1=l7_56%a,c1=l7_56%c,a2=u
* 756_12(i1)%a,b2=u756_12(i1)%b,c2=u756_12(i1)%c,d2=u756_12(i1)%d,prq=p7
* 56q,nsum=0
      l7_5612(i1)%c(2)=l7_56%c(2)*p756q*u756_12(i1)%d(1)+l7_56%a
     & (2)*u756_12(i1)%c(2)
      l7_5612(i1)%a(2)=l7_56%c(2)*p756q*u756_12(i1)%b(1)+l7_56%a
     & (2)*u756_12(i1)%a(2)
      end do
...
* =0
      l7_1256(i1)%c(2)=l7_12(i1)%c(2)*p712q*u712_56%d(1)+l7_12(i
     & 1)%a(2)*u712_56%c(2)
      l7_1256(i1)%a(2)=l7_12(i1)%c(2)*p712q*u712_56%b(1)+l7_12(i
     & 1)%a(2)*u712_56%a(2)
      end do
...
* 4(i3)%d,prq=p712q,nsum=0
     ...
     & l7_12(i1)%a(2)*u712_34(i3)%a(2)
      ...
      do i1=1,2
* TLT0_W -- aa=l7_5634(i1)%a,cc=l7_5634(i1)%c,a1=l7_56%a,c1=l7_56%c,a2=u
* 756_34(i1)%a,b2=u756_34(i1)%b,c2=u756_34(i1)%c,d2=u756_34(i1)%d,prq=p7
* 56q,nsum=0
      l7_5634(i1)%c(2)=l7_56%c(2)*p756q*u756_34(i1)%d(1)+l7_56%a
     & (2)*u756_34(i1)%c(2)
      l7_5634(i1)%a(2)=l7_56%c(2)*p756q*u756_34(i1)%b(1)+l7_56%a
     & (2)*u756_34(i1)%a(2)
      end do
...
* =0
      l7_3456(i1)%c(2)=l7_34(i1)%c(2)*p734q*u734_56%d(1)+l7_34(i
     & 1)%a(2)*u734_56%c(2)
      l7_3456(i1)%a(2)=l7_34(i1)%c(2)*p734q*u734_56%b(1)+l7_34(i
     & 1)%a(2)*u734_56%a(2)
      end do
  
      do i1=1,2
      do i3=1,2
* TLT0_W -- aa=l7_3412(i1,i3)%a,cc=l7_3412(i1,i3)%c,a1=l7_34(i1)%a,c1=l7
* _34(i1)%c,a2=u734_12(i3)%a,b2=u734_12(i3)%b,c2=u734_12(i3)%c,d2=u734_1
* 2(i3)%d,prq=p734q,nsum=0
      l7_3412(i1,i3)%c(2)=l7_34(i1)%c(2)*p734q*u734_12(i3)%d(1)+
     & l7_34(i1)%a(2)*u734_12(i3)%c(2)
      l7_3412(i1,i3)%a(2)=l7_34(i1)%c(2)*p734q*u734_12(i3)%b(1)+
     & l7_34(i1)%a(2)*u734_12(i3)%a(2)
      end do
      end do
...
* %a,b2=r2_34(i3)%b,prq=p234q,bef=,aft=
     ...
     & 56%a(2)*r2_34(i3)%a(2))
      ...
      do i3=1,2
* TLTR0_W -- aa=c3fk12_345678(i3),a1=l1_7834(i3)%a,c1=l1_7834(i3)%c,a2=r
* 2_56%a,b2=r2_56%b,prq=p256q,bef=c3fk12_345678(i3)+,aft=
      c3fk12_345678(i3)=c3fk12_345678(i3)+(l1_7834(i3)%c(2)*p256
     & q*r2_56%b(1)+l1_7834(i3)%a(2)*r2_56%a(2))
      end do
...
* %a,b2=r2_34(i3)%b,prq=p234q,bef=,aft=
     ...
     & 78%a(2)*r2_34(i3)%a(2))
      ...
      do i3=1,2
* TLTR0_W -- aa=c3fk12_345678(i3),a1=l1_5634(i3)%a,c1=l1_5634(i3)%c,a2=r
* 2_78%a,b2=r2_78%b,prq=p278q,bef=c3fk12_345678(i3)+,aft=
      c3fk12_345678(i3)=c3fk12_345678(i3)+(l1_5634(i3)%c(2)*p278
     & q*r2_78%b(1)+l1_5634(i3)%a(2)*r2_78%a(2))
      end do
...
* %a,b2=r4_12(i3)%b,prq=p412q,bef=,aft=
     ...
     & 56%a(2)*r4_12(i3)%a(2))
      ...
      do i3=1,2
* TLTR0_W -- aa=c3fk34_125678(i3),a1=l3_7812(i3)%a,c1=l3_7812(i3)%c,a2=r
* 4_56%a,b2=r4_56%b,prq=p456q,bef=c3fk34_125678(i3)+,aft=
      c3fk34_125678(i3)=c3fk34_125678(i3)+(l3_7812(i3)%c(2)*p456
     & q*r4_56%b(1)+l3_7812(i3)%a(2)*r4_56%a(2))
      end do
...
* %a,b2=r4_12(i3)%b,prq=p412q,bef=,aft=
     ...
     & 78%a(2)*r4_12(i3)%a(2))
      ...
      do i3=1,2
* TLTR0_W -- aa=c3fk34_125678(i3),a1=l3_5612(i3)%a,c1=l3_5612(i3)%c,a2=r
* 4_78%a,b2=r4_78%b,prq=p478q,bef=c3fk34_125678(i3)+,aft=
      c3fk34_125678(i3)=c3fk34_125678(i3)+(l3_5612(i3)%c(2)*p478
     & q*r4_78%b(1)+l3_5612(i3)%a(2)*r4_78%a(2))
      end do
...
* main line W                                                           
      ...
      do i1=1,2
      do i3=1,2
* TLTR0_W -- aa=c3fk56_123478(i1,i3),a1=l5_7812(i1)%a,c1=l5_7812(i1)%c,a
* 2=r6_34(i3)%a,b2=r6_34(i3)%b,prq=p634q,bef=,aft=
      c3fk56_123478(i1,i3)=(l5_7812(i1)%c(2)*p634q*r6_34(i3)%b(1
     & )+l5_7812(i1)%a(2)*r6_34(i3)%a(2))
      end do
      end do
  
      do i1=1,2
      do i3=1,2
* TLTR0_W -- aa=c3fk56_123478(i1,i3),a1=l5_7834(i3)%a,c1=l5_7834(i3)%c,a
* 2=r6_12(i1)%a,b2=r6_12(i1)%b,prq=p612q,bef=c3fk56_123478(i1,i3)+,aft=
      c3fk56_123478(i1,i3)=c3fk56_123478(i1,i3)+(l5_7834(i3)%c(2
     & )*p612q*r6_12(i1)%b(1)+l5_7834(i3)%a(2)*r6_12(i1)%a(2))
      end do
      end do
...
* 2=r6_34(i3)%a,b2=r6_34(i3)%b,prq=p634q,bef=c3fk56_123478(i1,i3)+,aft=
      c3fk56_123478(i1,i3)=c3fk56_123478(i1,i3)+(l5_1278(i1)%c(2
     & )*p634q*r6_34(i3)%b(1)+l5_1278(i1)%a(2)*r6_34(i3)%a(2))
      end do
      end do
...
* 3)%c,a2=r6_78%a,b2=r6_78%b,prq=p678q,bef=c3fk56_123478(i1,i3)+,aft=
     ...
     & c(2)*p678q*r6_78%b(1)+l5_1234(i1,i3)%a(2)*r6_78%a(2))
      ...
      do i1=1,2
      do i3=1,2
* TLTR0_W -- aa=c3fk56_123478(i1,i3),a1=l5_3412(i3,i1)%a,c1=l5_3412(i3,i
* 1)%c,a2=r6_78%a,b2=r6_78%b,prq=p678q,bef=c3fk56_123478(i1,i3)+,aft=
      c3fk56_123478(i1,i3)=c3fk56_123478(i1,i3)+(l5_3412(i3,i1)%
     & c(2)*p678q*r6_78%b(1)+l5_3412(i3,i1)%a(2)*r6_78%a(2))
      end do
      end do
      ...
      do i1=1,2
      do i3=1,2
* TLTR0_W -- aa=c3fk78_123456(i1,i3),a1=l7_5612(i1)%a,c1=l7_5612(i1)%c,a
* 2=r8_34(i3)%a,b2=r8_34(i3)%b,prq=p834q,bef=,aft=
      c3fk78_123456(i1,i3)=(l7_5612(i1)%c(2)*p834q*r8_34(i3)%b(1
     & )+l7_5612(i1)%a(2)*r8_34(i3)%a(2))
      end do
      end do
  
      do i1=1,2
      do i3=1,2
* TLTR0_W -- aa=c3fk78_123456(i1,i3),a1=l7_5634(i3)%a,c1=l7_5634(i3)%c,a
* 2=r8_12(i1)%a,b2=r8_12(i1)%b,prq=p812q,bef=c3fk78_123456(i1,i3)+,aft=
      c3fk78_123456(i1,i3)=c3fk78_123456(i1,i3)+(l7_5634(i3)%c(2
     & )*p812q*r8_12(i1)%b(1)+l7_5634(i3)%a(2)*r8_12(i1)%a(2))
      end do
      end do
...
* 2=r8_34(i3)%a,b2=r8_34(i3)%b,prq=p834q,bef=c3fk78_123456(i1,i3)+,aft=
      c3fk78_123456(i1,i3)=c3fk78_123456(i1,i3)+(l7_1256(i1)%c(2
     & )*p834q*r8_34(i3)%b(1)+l7_1256(i1)%a(2)*r8_34(i3)%a(2))
      end do
      end do
...
* 3)%c,a2=r8_56%a,b2=r8_56%b,prq=p856q,bef=c3fk78_123456(i1,i3)+,aft=
     ...
     & c(2)*p856q*r8_56%b(1)+l7_1234(i1,i3)%a(2)*r8_56%a(2))
      ...
      do i1=1,2
      do i3=1,2
* TLTR0_W -- aa=c3fk78_123456(i1,i3),a1=l7_3412(i3,i1)%a,c1=l7_3412(i3,i
* 1)%c,a2=r8_56%a,b2=r8_56%b,prq=p856q,bef=c3fk78_123456(i1,i3)+,aft=
      c3fk78_123456(i1,i3)=c3fk78_123456(i1,i3)+(l7_3412(i3,i1)%
     & c(2)*p856q*r8_56%b(1)+l7_3412(i3,i1)%a(2)*r8_56%a(2))
      end do
      end do
...
* pk0 -- p=cz1234(i1,i3)%e
      ...
      do i3=1,2
      do m=0,3
* TLTR0 -- aa=cf1234(&,i3)%e(m),a1=lf1_34(m)%a,c1=lf1_34(m)%c,a2=r2_34(i
* 3)%a,b2=r2_34(i3)%b,prq=p234q,bef=,aft=
      cf1234(1,i3)%e(m)=(lf1_34(m)%a(1)*r2_34(i3)%a(1)+lf1_34(m)
     & %c(1)*p234q*r2_34(i3)%b(2))
      cf1234(2,i3)%e(m)=(lf1_34(m)%c(2)*p234q*r2_34(i3)%b(1)+lf1
     & _34(m)%a(2)*r2_34(i3)%a(2))
      end do
      end do
      ...
      do i3=1,2
      do m=0,3
* TLTR0 -- aa=cf1234(&,i3)%e(m),a1=l1_34(i3)%a,c1=l1_34(i3)%c,a2=rf2_34(
* m)%a,b2=rf2_34(m)%b,prq=p134q,bef=cf1234(&,i3)%e(m)+,aft=
      cf1234(1,i3)%e(m)=cf1234(1,i3)%e(m)+(l1_34(i3)%a(1)*rf2_34
     & (m)%a(1)+l1_34(i3)%c(1)*p134q*rf2_34(m)%b(2))
      cf1234(2,i3)%e(m)=cf1234(2,i3)%e(m)+(l1_34(i3)%c(2)*p134q*
     & rf2_34(m)%b(1)+l1_34(i3)%a(2)*rf2_34(m)%a(2))
      end do
      end do
  
      do i1=1,2
      do m=0,3
* TLTR0 -- aa=cf1234(i1,&)%e(m),a1=lf3_12(m)%a,c1=lf3_12(m)%c,a2=r4_12(i
* 1)%a,b2=r4_12(i1)%b,prq=p412q,bef=cf1234(i1,&)%e(m)+,aft=
      cf1234(i1,1)%e(m)=cf1234(i1,1)%e(m)+(lf3_12(m)%a(1)*r4_12(
     & i1)%a(1)+lf3_12(m)%c(1)*p412q*r4_12(i1)%b(2))
      cf1234(i1,2)%e(m)=cf1234(i1,2)%e(m)+(lf3_12(m)%c(2)*p412q*
     & r4_12(i1)%b(1)+lf3_12(m)%a(2)*r4_12(i1)%a(2))
      end do
      end do
  
      do i1=1,2
      do m=0,3
* TLTR0 -- aa=cf1234(i1,&)%e(m),a1=l3_12(i1)%a,c1=l3_12(i1)%c,a2=rf4_12(
* m)%a,b2=rf4_12(m)%b,prq=p312q,bef=cf1234(i1,&)%e(m)+,aft=
      cf1234(i1,1)%e(m)=cf1234(i1,1)%e(m)+(l3_12(i1)%a(1)*rf4_12
     & (m)%a(1)+l3_12(i1)%c(1)*p312q*rf4_12(m)%b(2))
      cf1234(i1,2)%e(m)=cf1234(i1,2)%e(m)+(l3_12(i1)%c(2)*p312q*
     & rf4_12(m)%b(1)+l3_12(i1)%a(2)*rf4_12(m)%a(2))
      end do
      end do
...
* p.q -- p.q=c4aux(i1,i3),p=cz1234(i1,i3)%e,q=cz5678%e,bef=,aft=
     ...
     & 1,i3)%e(3)*cz5678%e(3))
      ...
      do i1=1,2
      do i3=1,2
       c1234(i1,i3)= c4aux(i1,i3)/(-p1234q+cmz2)
      enddo
      enddo
...
*   foton                                                               
      do i1=1,2
      do i3=1,2
* p.q -- p.q=c4aux(i1,i3),p=cf1234(i1,i3)%e,q=cf5678%e,bef=,aft=
      c4aux(i1,i3)=(cf1234(i1,i3)%e(0)*cf5678%e(0)-cf1234(i1,i3)
     & %e(1)*cf5678%e(1)-cf1234(i1,i3)%e(2)*cf5678%e(2)-cf1234(i
     & 1,i3)%e(3)*cf5678%e(3))
      end do
      end do
      ...
      do i1=1,2
      do i3=1,2
       c1234(i1,i3)= c1234(i1,i3)+c4aux(i1,i3)/(-p1234q)
      enddo
      enddo
...
*       do i1=1,2                                                       
*       do i3=1,2                                                       
*        c1234(i1,i3)= c1234(i1,i3)+ch1234(i1,i3)*ch5678/(p1234q-cmh2)  
*       enddo                                                           
*       enddo                                                           
        ...
        if (i_signal.eq.0) then
          do i1=1,2
            do i3=1,2
              c1234(i1,i3)=
     &           c1234(i1,i3)+ch1234(i1,i3)*ch5678*
     &            (rhzz*rhww/(p1234q-cmh2)+rhhzz*rhhww/(p1234q-cmhh2))
            enddo
          enddo
...
* p.q -- p.q=c2aux2(i3),p=cw3478(i3)%e,q=p1256,bef=,aft=
     ...
     & (1)-cw3478(i3)%e(2)*p1256(2)-cw3478(i3)%e(3)*p1256(3))
      ...
      do i1=1,2
      do i3=1,2
       c1256(i1,i3)= (c4aux(i1,i3)-c2aux1(i1)*c2aux2(i3)/cmw2)
     &     /(-p1256q+cmw2)
      enddo
      enddo
...
* p.q -- p.q=c2aux2(i3),p=cw3456(i3)%e,q=p1278,bef=,aft=
     ...
     & (1)-cw3456(i3)%e(2)*p1278(2)-cw3456(i3)%e(3)*p1278(3))
      ...
      do i1=1,2
      do i3=1,2
       c1278(i1,i3)= (c4aux(i1,i3)-c2aux1(i1)*c2aux2(i3)/cmw2)
     &     /(-p1278q+cmw2)
      enddo
      enddo
...
*                                                                       
       ...
       if (i_unitarize.eq.1) then
        ...
        call unit_2z2w_massless(p12,s12,cz12,p34,s34,cz34,
     &    p56,s56,cw56,p78,s78,cw78,cunit)
        ...
        do i3=1,2
*	 print*, 'i1,i3=',i1,i3                                               
*         print*, 'cquart=',cquart(i1,i3)                               
*	 print*, 'cunit=',cunit(i1,i3)                                        
         cquart(i1,i3)=cquart(i1,i3)+cunit(i1,i3)
        enddo
        enddo
...
*      do i1=1,2                                                        
*      do i3=1,2                                                        
*        cres(i1,i3)= (c3fk_tot(i1,i3)+c1234(i1,i3)+                    
*     &        c1256(i1,i3)+c1278(i1,i3)+cquart(i1,i3))/spk0            
*      enddo                                                            
*      enddo                                                            
...
* six                                                                   
*      elseif (i_signal.eq.1) then                                      
      elseif (i_signal.ge.1) then
* sixend                                                                
        do i1=1,2
          do i3=1,2
            cres(i1,i3)= (c1234(i1,i3))/spk0
          enddo
        enddo
      endif
* sigend                                                                

...
* The diagrams are symmetric under 2 <--> 4. Therefore use s and u as independent invariant
...
L AWWWW4 = - MW^2*(e1.e2*e3.e4)/d12H;
...
L AWWWW5 = - MW^2*(e1.e4*e2.e3)/d14H;

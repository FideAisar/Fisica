...
***********************************************************************
     ...
     &           ' cosalf=ghfactor=',ghfactor
      ...
      call gridHt(rmh,gamh)
        ...
        print*,'rmh  =',rmh,'  gamh  =',gamh

      IF(rmhh.GT.0.d0 .and. ghhfactor.GT.0.d0) then
        call gridHt(rmhh,gamhh)
        gamhh=gamhh*ghhfactor**2
        print*,' '
        print*,'rmhh =',rmhh,'  gamhh (gamH2hh=0) =',gamhh
* Add H->hh channel

...
*      COMMON/coupling_readinput/ghfactor
      COMMON/coupling_readinput/ghfactor,ghhfactor
* heavhend
c s14end
...
* heavh
      if (rmh.gt.0.d0.and.rmhh.gt.0.d0.and.gamhh.lt.0.d0) then
...
*  For this reaso we put here ALL b masses =0
c      rmass(5)=rmb
c      rmass2(5)=rmb2
c      cmass2(5)=rmb2
      rmass(5)=0.d0
...
* couplings
      ...
      if (rmh.ge.0.d0) then
c s14
c        rhbb=-rmb_run/(2.d0*rmw*sw)
c        rhtt=-rmt_run/(2.d0*rmw*sw)
...
* heavh
      if (rmh.ge.0.d0.and.rmhh.ge.0.d0) then
        rhhbb=-rmb_run/(2.d0*rmw*sw) *ghhfactor
        rhhtt=-rmt_run/(2.d0*rmw*sw) *ghhfactor
        rhhww=rmw/sw *ghhfactor
        rhhzz=rmz/sw/rcw *ghhfactor
        r3hh=-3.d0*rmh2/(sw*2.d0*rmw) *ghhfactor
        r2hh2w=-1.d0/(2.d0*s2w)*ghhfactor
        r2hh2z=-1.d0/(2.d0*s2w*rc2w) *ghhfactor
        r4hh=+3.d0*rmh2/(4.d0*s2w*rmw2) *ghhfactor
      else
        rhhbb=0.d0
        rhhtt=0.d0
        rhhww=0.d0

{
	...
	double x_f[n] = {59.34, 100.59, 33.41, 8.8328, 30.01};    // frequenza in Hz
    double x_f_err[n] = {2.2114, 4.083, 5.72, 4.4313, 1.662};  // errore Hz

    double y_v[n] = {230, 401, 10, 50, 30};         // tensione in mV
    double y_v_err[n] = {16, 9, 5, 5, 4};            // errore mV
